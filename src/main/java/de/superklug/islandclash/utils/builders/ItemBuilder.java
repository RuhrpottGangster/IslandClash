package de.superklug.islandclash.utils.builders;
...
public class ItemBuilder {
    ...
    public ItemBuilder(final IslandClash module, final Material type, final int amount, final short damage) {
        this.module = module;
        this.currentItem = new ItemStack(type, amount, damage);
    }

    public ItemBuilder(final IslandClash module, final Material type, final int amount) {
        this.module = module;
        this.currentItem = new ItemStack(type, amount, (short) 0);
    }

    public ItemBuilder(final IslandClash module, final Material type) {
        this.module = module;
